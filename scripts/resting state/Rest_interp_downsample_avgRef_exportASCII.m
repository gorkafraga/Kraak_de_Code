...
diroutput = 'Z:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_pre\Edit Channels\ASCIIs AvgRef Fixed';
diroutput_BVA = 'Z:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_pre\Edit Channels\BrainVisionAnalyzer fixed';
...
cd (diroutput);    
   ...
   for seg = 1:30
         fileoutput = [fileinput(1:4),'_4sSeg_AvgRef_',num2str(seg),'.txt'];
