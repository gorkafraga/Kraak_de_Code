...
% =========================================================================
clear all
dirbadsegments = 'Z:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_pre\BAD SEGMENT INDEXES' ;
...
names = files(~cellfun('isempty', strfind(files,'ep4s.set'))); % only files iwth bad segments marked
