...
% =====================================================================
dirinput=  'Z:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\Brainwave_anal';
diroutput = 'Z:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\Brainwave_anal';
cd (dirinput)
%% define filenames
band= 'Alpha';
