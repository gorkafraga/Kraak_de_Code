...
clear all; close all;
dirinput = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\redoICA\' ;
diroutput = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\redoICA';
diroutput_BVA = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\redoICA'; 
dirdummy = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post';
...
chanlocsfile = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\channelsThetaPhi-64scalp.elp'; 
