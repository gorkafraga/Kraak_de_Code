...
% =========================================================================
clear all
dirbadsegments = 'X:\fraga\EEG_ABMP\Kraak_analysis\Kraak EEG\resting-state EEG\output_post\bad segments index post' ;
...
%% loop
for ss = 1:length(names); % !!! loop start point modified!
    fileinput = names{ss};
    ppnr = fileinput(2:4) ;
    % load dataset
    eeglab;
