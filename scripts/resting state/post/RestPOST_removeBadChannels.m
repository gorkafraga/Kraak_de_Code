...
names = files(~cellfun('isempty', strfind(files,'timesCoded_ep4s.set'))); % load sets with marked bad epochs
...
chans2remove = {'none'}; % the default is none. But...
 if s == 1; 
     chans2remove = {'T8','TP8'};  
  elseif s==2;
      chans2remove = {'P6','P8','FC3','P9','O1','PO8'};  
  elseif s==6;
      chans2remove = {'O2','PO3','POz','PO4'};
  elseif s==7;
      chans2remove = {'AF4','Fz'};
  elseif s==9;
      chans2remove = {'CP4'};
  elseif s==29;
      chans2remove = {'FT8','P9','POz','P2'};
  elseif s==33;
      chans2remove = {'CP6'};
  elseif s==101;
      chans2remove = {'FC1','FC3'};
  elseif s==104;
      chans2remove = {'C4','FC4','PO7','Pz'};
  elseif s==107;
